  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <h1 className="text-3xl font-bold text-white font-[family-name:var(--font-playfair)]">{t(lang, 'portal', 'watchlistTitle')}</h1>
        <p className="text-[#7a8fa8] text-sm mt-1 font-[family-name:var(--font-inter)]">
          {horses.length} {t(lang, 'portal', 'watchlistCount')}
        </p>
      </div>
      ...
      {horses.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center bg-[#0a1428] rounded-2xl border border-[#c9a84c]/10">
          ...
          <h3 className="text-lg font-bold text-white mb-2 font-[family-name:var(--font-playfair)]">{t(lang, 'portal', 'watchlistEmpty')}</h3>
          <p className="text-sm text-[#7a8fa8] font-[family-name:var(--font-inter)]">
            {t(lang, 'portal', 'watchlistEmptyDesc')}
          </p>
        </div>
      ) : (
