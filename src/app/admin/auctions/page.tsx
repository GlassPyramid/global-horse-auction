...
import { Plus, Pencil, Eye, Gavel } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[#7a8fa8] text-sm mt-1 font-[family-name:var(--font-inter)]">{mockAuctions.length} auctions in the system</p>
        </div>
        <Link
              ...
              <div className="flex items-start justify-between gap-6">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    {auction.featured && (
                      <span className="text-[10px] font-bold px-2.5 py-1 rounded-full border bg-[#c9a84c]/10 text-[#c9a84c] border-[#c9a84c]/20 font-[family-name:var(--font-inter)]">
                        Featured
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex flex-wrap gap-4 text-xs text-[#7a8fa8] font-[family-name:var(--font-inter)]">
                    ...
                    <span>Closes: {formatDate(auction.endDate)}</span>
